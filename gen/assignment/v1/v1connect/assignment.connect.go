...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/happytree09/avante-microservice/assignment/v1"
	http "net/http"
	strings "strings"
)
...
var (
	assignmentServiceServiceDescriptor                = v1.File_assignment_v1_assignment_proto.Services().ByName("AssignmentService")

...
package assignmentconnect

import (
	connect "connectrpc.com/connect"
	context "context"
	errors "errors"
	assignment "github.com/happytree09/avante-microservice/assignment"
	http "net/http"
	strings "strings"
)
...
var (
	assignmentServiceServiceDescriptor                = assignment.File_assignment_v1_assignment_proto.Services().ByName("AssignmentService")
...
type AssignmentServiceClient interface {
	...
	CreateAssignment(context.Context, *connect.Request[assignment.CreateAssignmentRequest]) (*connect.Response[assignment.CreateAssignmentResponse], error)
	// Get details of a specific assignment
	GetAssignment(context.Context, *connect.Request[assignment.GetAssignmentRequest]) (*connect.Response[assignment.GetAssignmentResponse], error)
	// List all assignments
	ListAssignments(context.Context, *connect.Request[assignment.ListAssignmentsRequest]) (*connect.Response[assignment.ListAssignmentsResponse], error)
	// Update an existing assignment
	UpdateAssignment(context.Context, *connect.Request[assignment.UpdateAssignmentRequest]) (*connect.Response[assignment.UpdateAssignmentResponse], error)
	// Delete an assignment
	DeleteAssignment(context.Context, *connect.Request[assignment.DeleteAssignmentRequest]) (*connect.Response[assignment.DeleteAssignmentResponse], error)
}
...
func NewAssignmentServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AssignmentServiceClient {
	...
	return &assignmentServiceClient{
		createAssignment: connect.NewClient[assignment.CreateAssignmentRequest, assignment.CreateAssignmentResponse](
			httpClient,
		...
		getAssignment: connect.NewClient[assignment.GetAssignmentRequest, assignment.GetAssignmentResponse](
			httpClient,
			baseURL+AssignmentServiceGetAssignmentProcedure,
			connect.WithSchema(assignmentServiceGetAssignmentMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
		listAssignments: connect.NewClient[assignment.ListAssignmentsRequest, assignment.ListAssignmentsResponse](
			httpClient,
			baseURL+AssignmentServiceListAssignmentsProcedure,
			connect.WithSchema(assignmentServiceListAssignmentsMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
		updateAssignment: connect.NewClient[assignment.UpdateAssignmentRequest, assignment.UpdateAssignmentResponse](
			httpClient,
			baseURL+AssignmentServiceUpdateAssignmentProcedure,
			connect.WithSchema(assignmentServiceUpdateAssignmentMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
		deleteAssignment: connect.NewClient[assignment.DeleteAssignmentRequest, assignment.DeleteAssignmentResponse](
			httpClient,
...
type assignmentServiceClient struct {
	createAssignment *connect.Client[assignment.CreateAssignmentRequest, assignment.CreateAssignmentResponse]
	getAssignment    *connect.Client[assignment.GetAssignmentRequest, assignment.GetAssignmentResponse]
	listAssignments  *connect.Client[assignment.ListAssignmentsRequest, assignment.ListAssignmentsResponse]
	updateAssignment *connect.Client[assignment.UpdateAssignmentRequest, assignment.UpdateAssignmentResponse]
	deleteAssignment *connect.Client[assignment.DeleteAssignmentRequest, assignment.DeleteAssignmentResponse]
}

// CreateAssignment calls assignment.v1.AssignmentService.CreateAssignment.
func (c *assignmentServiceClient) CreateAssignment(ctx context.Context, req *connect.Request[assignment.CreateAssignmentRequest]) (*connect.Response[assignment.CreateAssignmentResponse], error) {
	return c.createAssignment.CallUnary(ctx, req)
}

// GetAssignment calls assignment.v1.AssignmentService.GetAssignment.
func (c *assignmentServiceClient) GetAssignment(ctx context.Context, req *connect.Request[assignment.GetAssignmentRequest]) (*connect.Response[assignment.GetAssignmentResponse], error) {
	return c.getAssignment.CallUnary(ctx, req)
}

// ListAssignments calls assignment.v1.AssignmentService.ListAssignments.
func (c *assignmentServiceClient) ListAssignments(ctx context.Context, req *connect.Request[assignment.ListAssignmentsRequest]) (*connect.Response[assignment.ListAssignmentsResponse], error) {
	return c.listAssignments.CallUnary(ctx, req)
}

// UpdateAssignment calls assignment.v1.AssignmentService.UpdateAssignment.
func (c *assignmentServiceClient) UpdateAssignment(ctx context.Context, req *connect.Request[assignment.UpdateAssignmentRequest]) (*connect.Response[assignment.UpdateAssignmentResponse], error) {
	return c.updateAssignment.CallUnary(ctx, req)
}

// DeleteAssignment calls assignment.v1.AssignmentService.DeleteAssignment.
func (c *assignmentServiceClient) DeleteAssignment(ctx context.Context, req *connect.Request[assignment.DeleteAssignmentRequest]) (*connect.Response[assignment.DeleteAssignmentResponse], error) {
...
func (UnimplementedAssignmentServiceHandler) CreateAssignment(context.Context, *connect.Request[assignment.CreateAssignmentRequest]) (*connect.Response[assignment.CreateAssignmentResponse], error) {
...
func (UnimplementedAssignmentServiceHandler) GetAssignment(context.Context, *connect.Request[assignment.GetAssignmentRequest]) (*connect.Response[assignment.GetAssignmentResponse], error) {
...
func (UnimplementedAssignmentServiceHandler) ListAssignments(context.Context, *connect.Request[assignment.ListAssignmentsRequest]) (*connect.Response[assignment.ListAssignmentsResponse], error) {
...
func (UnimplementedAssignmentServiceHandler) UpdateAssignment(context.Context, *connect.Request[assignment.UpdateAssignmentRequest]) (*connect.Response[assignment.UpdateAssignmentResponse], error) {
...
func (UnimplementedAssignmentServiceHandler) DeleteAssignment(context.Context, *connect.Request[assignment.DeleteAssignmentRequest]) (*connect.Response[assignment.DeleteAssignmentResponse], error) {
